/* Q.1 1. Who is the senior most employee based on job title? */

select * from employee    -- WE can get employee information from employee table 
order by levels desc      -- levels columns can use to find senior employee
limit 1
